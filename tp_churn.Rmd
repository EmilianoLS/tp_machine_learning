...
# filtro por el umbral  min 0.7
indice_col <- c(findCorrelation(MAtriz_correlacion, 0.7))
# identifico las variables con correlacion mayor a 0.7
Columnas_Cor <-names(data[,indice_col])
...
Vemos que hay 221 variables con una correlacion bastante elevada, esto nos podria traer problemas de
multicolinealiad con nuestro modelo y afectar su performance. En este sentido tambien exploramos la varianza en los datos de cada columna, encontramos que ninguno tiene varianza 0 y hay 257 datos que si tienen una varianza cercana a 0, que podemos interpretar esto en que tengan poca incidencia en la funcion a determinar por el modelo o por el contrario, que tengan alto grado de impacto en la funcion y capacidad de prediccion de mi modelo. 
